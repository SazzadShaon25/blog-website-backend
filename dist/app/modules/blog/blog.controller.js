...
const updateBlog = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield blog_service_1.BlogServices.updateBlogIntoDb(req.body, req.user, id);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const deleteBlog = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result = yield blog_service_1.BlogServices.deleteBlogFromDb(req.user, id);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
